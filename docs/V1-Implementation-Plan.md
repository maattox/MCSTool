...
| **8.15** | Change pack UX (single-list review, compactness, overlay dock, stopped-VM pick) | **NEXT** — [`V1-Change-Pack-UX-Plan.md`](V1-Change-Pack-UX-Plan.md) **P4** |
...
**Current NEXT step:** See [`docs/NEXT.md`](NEXT.md) — Step **8.15 P4** (pick/review when VM stopped). **Do not start** Pass 3, **8.6.1**, or **9.1**.
...
| `[V1-Change-Pack-UX-Plan.md](V1-Change-Pack-UX-Plan.md)` | Step **8.15**. Single-list review, Change pack compactness, overlay dock, stopped-VM pick. **P1–P3 DONE. P4 NEXT**. Pass 3 still needs the operator to start it |
