...
**Pass:** 3  
**Status:** **BLOCKED** — do not fill until Steps **8.7** and **8.8** exit and the operator starts Pass 3.  
...
Do not start 8.6.1 or 9.1. Do not create a Pass 3 bug-fix plan until this file is filled and the operator asks for triage.
...
Wait until the pass is filled. Template: [`V1-Bug-Fix-Plan-TEMPLATE.md`](V1-Bug-Fix-Plan-TEMPLATE.md).
