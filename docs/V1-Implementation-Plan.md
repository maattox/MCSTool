...
| **8.7** | Modpack-test follow-on (Change pack failures)              | **NEXT** = [`V1-Modpack-Test-Follow-On-Plan.md`](V1-Modpack-Test-Follow-On-Plan.md) **P4** |
...
**Status:** NEXT (living: [`V1-Modpack-Test-Follow-On-Plan.md`](V1-Modpack-Test-Follow-On-Plan.md) **P4**)  
...
| `[V1-Modpack-Test-Follow-On-Plan.md](V1-Modpack-Test-Follow-On-Plan.md)` | Step **8.7**. Informal Change pack failures. **NEXT = P4** (P1–P3 DONE) |
