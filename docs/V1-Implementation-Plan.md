...
| **8.14** | Manage UI pass 3 (window edge, density, pins, Overview) | **NEXT** — [`V1-Manage-UI-Pass-3-Plan.md`](V1-Manage-UI-Pass-3-Plan.md) P2 |
...
**Current NEXT step:** See [`docs/NEXT.md`](NEXT.md) — Step **8.14** P2 (sidebar density). **Do not start** Pass 3, **8.6.1**, or **9.1**.
...
| `[V1-Manage-UI-Pass-3-Plan.md](V1-Manage-UI-Pass-3-Plan.md)` | Step **8.14**. Window edge, sidebar density, pin redesign, Overview. **NEXT = P2**. Pass 3 still needs the operator to start it |
