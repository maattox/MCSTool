...
| **4** | Setup game types (Paper, loaders, pack import) | **NEXT** = Step **4.3** |
...
**Current NEXT step:** [Step 4.3](#step-43--setup-wizard-default-vs-optimized-vanilla). **Do not start Step 4.3** until the operator asks.
