...
| **8.10** | Operator-notes follow-on 2 (density, MOTD, VM1 icon)     | **NEXT** — [`V1-Operator-Notes-Follow-On-2-Plan.md`](V1-Operator-Notes-Follow-On-2-Plan.md) **P3** |
...
**Current NEXT step:** See [`docs/NEXT.md`](NEXT.md) — Step **8.10** P3. **Do not start Step 8.5.2** (Pass 3) until **8.10** exits and the operator says so. **Do not start Step 8.6.1** until Phase 8.5 exits. **Do not start Step 9.1** until Phase 8.5 **and** Step **8.6.1** are DONE.
