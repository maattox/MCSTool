...
| **8.4** | Pass-2 follow-on (operator notes)                          | **NEXT** = [`V1-Pass-2-Follow-On-Plan.md`](V1-Pass-2-Follow-On-Plan.md) **P9** |
...
**Status:** NEXT (living: [`V1-Pass-2-Follow-On-Plan.md`](V1-Pass-2-Follow-On-Plan.md) **P9**)  
