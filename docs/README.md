...
| [`V1-Manage-Sidebar-Redesign-Plan.md`](V1-Manage-Sidebar-Redesign-Plan.md) | Step **8.12**. Manage sidebar layout. **P2 NEXT.** |
...
| [`V1-QA-Pass-3-Scope.md`](V1-QA-Pass-3-Scope.md) | Pass 3 (blocked until **8.12** exits and the operator starts it). |
